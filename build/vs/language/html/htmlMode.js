define("vs/language/html/workerManager", ["require", "exports"], function(require2, exports2) {
  "use strict";
  ...
  exports2.WorkerManager = WorkerManager;
});
...
(function(factory) {
  ...
  })(ScannerState = exports2.ScannerState || (exports2.ScannerState = {}));
...
(function(factory) {
  ...
  var htmlLanguageTypes_1 = require2("../htmlLanguageTypes");
  ...
  function createScanner(input, initialOffset, initialState) {
    ...
    if (initialState === void 0) {
      initialState = htmlLanguageTypes_1.ScannerState.WithinContent;
    }
...
(function(factory) {
  ...
  var arrays = require2("../utils/arrays");
  exports2.VOID_ELEMENTS = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"];
  function isVoidElement(e) {
    return !!e && arrays.binarySearch(exports2.VOID_ELEMENTS, e.toLowerCase(), function(s1, s2) {
...
(function(factory) {
  ...
  var htmlScanner_1 = require2("./htmlScanner");
  var arrays_1 = require2("../utils/arrays");
  var htmlLanguageTypes_1 = require2("../htmlLanguageTypes");
  var fact_1 = require2("../languageFacts/fact");
  var Node = function() {
    ...
    Node2.prototype.findNodeBefore = function(offset) {
      var idx = arrays_1.findFirst(this.children, function(c) {
...
(function(factory) {
  ...
  exports2.isLetterOrDigit = isLetterOrDigit;
});
(function(factory) {
  if (typeof module === "object" && typeof module.exports === "object") {
    var v = factory(require, exports);
  ...
  exports2.normalizeMarkupContent = normalizeMarkupContent;
});
(function(factory) {
  if (typeof module === "object" && typeof module.exports === "object") {
    var v = factory(require, exports);
  ...
  var markup_1 = require2("../utils/markup");
  ...
  exports2.HTMLDataProvider = HTMLDataProvider;
  ...
  exports2.generateDocumentation = generateDocumentation;
});
(function(factory) {
  if (typeof module === "object" && typeof module.exports === "object") {
    var v = factory(require, exports);
...
(function(factory) {
  ...
  var dataProvider_1 = require2("./dataProvider");
  var webCustomData_1 = require2("./data/webCustomData");
  exports2.builtinDataProviders = [new dataProvider_1.HTMLDataProvider("html5", webCustomData_1.htmlData)];
  var customDataProviders = [];
  function getAllDataProviders() {
    return exports2.builtinDataProviders.concat(customDataProviders);
  }
  exports2.getAllDataProviders = getAllDataProviders;
  function handleCustomDataProviders(providers) {
    providers.forEach(function(p) {
      customDataProviders.push(p);
    });
  }
  exports2.handleCustomDataProviders = handleCustomDataProviders;
});
(function(factory) {
  if (typeof module === "object" && typeof module.exports === "object") {
    var v = factory(require, exports);
...
(function(factory) {
  ...
  var vscode_languageserver_types_1 = require2("vscode-languageserver-types");
  var htmlScanner_1 = require2("../parser/htmlScanner");
  var htmlLanguageTypes_1 = require2("../htmlLanguageTypes");
  var htmlEntities_1 = require2("../parser/htmlEntities");
  var nls = require2("vscode-nls");
  var strings_1 = require2("../utils/strings");
  var builtinDataProviders_1 = require2("../languageFacts/builtinDataProviders");
  var fact_1 = require2("../languageFacts/fact");
  var object_1 = require2("../utils/object");
  var dataProvider_1 = require2("../languageFacts/dataProvider");
  var localize = nls.loadMessageBundle();
  var HTMLCompletion = function() {
    function HTMLCompletion2(clientCapabilities) {
    ...
    HTMLCompletion2.prototype._doComplete = function(document, position, htmlDocument, settings) {
      ...
      var dataProviders = builtinDataProviders_1.getAllDataProviders().filter(function(p) {
        ...
        while (curr) {
          ...
          if (tag && (!curr.closed || curr.endTagStart && curr.endTagStart > offset)) {
            ...
            if (startIndent !== null && endIndent !== null && startIndent !== endIndent) {
              ...
              item.textEdit = vscode_languageserver_types_1.TextEdit.replace(getReplaceRange(afterOpenBracket2 - 1 - endIndent.length), insertText);
        ...
        dataProviders.forEach(function(provider) {
          provider.provideTags().forEach(function(tag2) {
            result.items.push({
              label: "/" + tag2.name,
              kind: vscode_languageserver_types_1.CompletionItemKind.Property,
              documentation: dataProvider_1.generateDocumentation(tag2, doesSupportMarkdown),
              filterText: "/" + tag2 + closeTag,
              textEdit: vscode_languageserver_types_1.TextEdit.replace(range, "/" + tag2 + closeTag),
              insertTextFormat: vscode_languageserver_types_1.InsertTextFormat.PlainText
            });
          });
        });
  ...
  exports2.HTMLCompletion = HTMLCompletion;
  function isQuote(s) {
    return /^["']*$/.test(s);
  }
...
(function(factory) {
  ...
  var HTMLHover = function() {
    function HTMLHover2(clientCapabilities) {
      this.clientCapabilities = clientCapabilities;
    }
    HTMLHover2.prototype.doHover = function(document, position, htmlDocument) {
        ...
        var _loop_1 = function(provider2) {
          ...
          provider2.provideTags().forEach(function(tag2) {
            if (tag2.name.toLowerCase() === currTag.toLowerCase()) {
              ...
              var markupContent = dataProvider_1.generateDocumentation(tag2, doesSupportMarkdown);
        ...
        var _loop_2 = function(provider2) {
          ...
          provider2.provideAttributes(currTag).forEach(function(attr2) {
            if (currAttr === attr2.name && attr2.description) {
              hover = {
                contents: dataProvider_1.generateDocumentation(attr2, doesSupportMarkdown),
                range
              };
            }
          });
        ...
        var _loop_3 = function(provider2) {
          ...
          provider2.provideValues(currTag, currAttr).forEach(function(attrValue2) {
            if (currAttrValue === attrValue2.name && attrValue2.description) {
              hover = {
                contents: dataProvider_1.generateDocumentation(attrValue2, doesSupportMarkdown),
                range
              };
            }
          });
...
(function(factory) {
  ...
  exports2.js_beautify = js_beautify;
});
(function() {
...
(function() {
  ...
  if (typeof define === "function" && define.amd) {
    define("vscode-html-languageservice/beautify/beautify-html", ["require", "./beautify", "./beautify-css"], function(requireamd) {
      var js_beautify2 = requireamd("./beautify");
      var css_beautify2 = requireamd("./beautify-css");
      return {
...
(function(factory) {
  ...
  var vscode_languageserver_types_1 = require2("vscode-languageserver-types");
  var beautify_html_1 = require2("../beautify/beautify-html");
  var strings_1 = require2("../utils/strings");
...
(function(factory) {
  ...
  exports2.findDocumentLinks = findDocumentLinks;
});
(function(factory) {
  if (typeof module === "object" && typeof module.exports === "object") {
    var v = factory(require, exports);
  ...
  exports2.findDocumentHighlights = findDocumentHighlights;
...
(function(factory) {
  ...
  exports2.findDocumentSymbols = findDocumentSymbols;
...
(function(factory) {
  ...
  exports2.findMatchingTagPosition = findMatchingTagPosition;
});
(function(factory) {
  if (typeof module === "object" && typeof module.exports === "object") {
    var v = factory(require, exports);
...
(function(factory) {
  ...
  var vscode_languageserver_types_1 = require2("vscode-languageserver-types");
  var htmlScanner_1 = require2("../parser/htmlScanner");
  var htmlParser_1 = require2("../parser/htmlParser");
  var htmlLanguageTypes_1 = require2("../htmlLanguageTypes");
...
(function(factory) {
  ...
  var htmlScanner_1 = require2("./parser/htmlScanner");
  var htmlParser_1 = require2("./parser/htmlParser");
  var htmlCompletion_1 = require2("./services/htmlCompletion");
  var htmlHover_1 = require2("./services/htmlHover");
  var htmlFormatter_1 = require2("./services/htmlFormatter");
  var htmlLinks_1 = require2("./services/htmlLinks");
  var htmlHighlighting_1 = require2("./services/htmlHighlighting");
  var htmlSymbolsProvider_1 = require2("./services/htmlSymbolsProvider");
  var htmlRename_1 = require2("./services/htmlRename");
  var htmlMatchingTagPosition_1 = require2("./services/htmlMatchingTagPosition");
  var htmlFolding_1 = require2("./services/htmlFolding");
  var htmlSelectionRange_1 = require2("./services/htmlSelectionRange");
  var builtinDataProviders_1 = require2("./languageFacts/builtinDataProviders");
  var dataProvider_1 = require2("./languageFacts/dataProvider");
  __export2(require2("./htmlLanguageTypes"));
  ...
  function getLanguageService(options) {
    ...
    return {
      ...
      parseHTMLDocument: function(document) {
        return htmlParser_1.parse(document.getText());
      },
  ...
  exports2.newHTMLDataProvider = newHTMLDataProvider;
});
define("vscode-html-languageservice", ["vscode-html-languageservice/htmlLanguageService"], function(main) {
  return main;
});
define("vs/language/html/languageFeatures", ["require", "exports", "vscode-html-languageservice"], function(require2, exports2, htmlService) {
  "use strict";
  Object.defineProperty(exports2, "__esModule", {
    value: true
  });
  ...
  exports2.DiagnosticsAdapter = DiagnosticsAdapter;
  ...
  exports2.CompletionAdapter = CompletionAdapter;
  ...
  exports2.HoverAdapter = HoverAdapter;
  ...
  exports2.DocumentHighlightAdapter = DocumentHighlightAdapter;
  ...
  exports2.DocumentSymbolAdapter = DocumentSymbolAdapter;
  ...
  exports2.DocumentLinkAdapter = DocumentLinkAdapter;
  ...
  exports2.DocumentFormattingEditProvider = DocumentFormattingEditProvider;
  ...
  exports2.DocumentRangeFormattingEditProvider = DocumentRangeFormattingEditProvider;
  ...
  exports2.RenameAdapter = RenameAdapter;
  ...
  exports2.FoldingRangeAdapter = FoldingRangeAdapter;
  ...
  exports2.SelectionRangeAdapter = SelectionRangeAdapter;
});
define("vs/language/html/htmlMode", ["require", "exports", "./workerManager", "./languageFeatures"], function(require2, exports2, workerManager_1, languageFeatures) {
  "use strict";
  Object.defineProperty(exports2, "__esModule", {
    value: true
  });
  ...
  exports2.setupMode1 = setupMode1;
