define("vs/language/json/workerManager", ["require", "exports"], function(require2, exports2) {
  "use strict";
...
define("vs/language/json/languageFeatures", ["require", "exports", "vscode-json-languageservice"], function(require2, exports2, jsonService) {
  "use strict";
  Object.defineProperty(exports2, "__esModule", {
    value: true
  });
  ...
  exports2.DocumentColorAdapter = DocumentColorAdapter;
...
define("vs/language/json/tokenization", ["require", "exports", "jsonc-parser"], function(require2, exports2, json) {
  "use strict";
  Object.defineProperty(exports2, "__esModule", {
    value: true
  });
  ...
  exports2.createTokenizationSupport = createTokenizationSupport;
  exports2.TOKEN_DELIM_OBJECT = "delimiter.bracket.json";
  exports2.TOKEN_DELIM_ARRAY = "delimiter.array.json";
  exports2.TOKEN_DELIM_COLON = "delimiter.colon.json";
  exports2.TOKEN_DELIM_COMMA = "delimiter.comma.json";
  exports2.TOKEN_VALUE_BOOLEAN = "keyword.json";
  exports2.TOKEN_VALUE_NULL = "keyword.json";
  exports2.TOKEN_VALUE_STRING = "string.value.json";
  exports2.TOKEN_VALUE_NUMBER = "number.json";
  exports2.TOKEN_PROPERTY_NAME = "string.key.json";
  exports2.TOKEN_COMMENT_BLOCK = "comment.block.json";
  exports2.TOKEN_COMMENT_LINE = "comment.line.json";
  var JSONState = function() {
    function JSONState2(state, scanError, lastWasColon) {
      this._state = state;
      this.scanError = scanError;
      this.lastWasColon = lastWasColon;
    }
    JSONState2.prototype.clone = function() {
      return new JSONState2(this._state, this.scanError, this.lastWasColon);
    };
  ...
  function tokenize(comments, line, state, offsetDelta, stopAtOffset) {
    ...
    while (true) {
      ...
      switch (kind) {
        case 1:
          type = exports2.TOKEN_DELIM_OBJECT;
          lastWasColon = false;
          break;
        case 2:
          type = exports2.TOKEN_DELIM_OBJECT;
          ...
          break;
        case 3:
          type = exports2.TOKEN_DELIM_ARRAY;
          lastWasColon = false;
          break;
        case 4:
          type = exports2.TOKEN_DELIM_ARRAY;
          ...
          break;
        case 6:
          type = exports2.TOKEN_DELIM_COLON;
          lastWasColon = true;
          break;
        case 5:
          type = exports2.TOKEN_DELIM_COMMA;
          lastWasColon = false;
          break;
        case 8:
        case 9:
          type = exports2.TOKEN_VALUE_BOOLEAN;
          lastWasColon = false;
          break;
        case 7:
          type = exports2.TOKEN_VALUE_NULL;
          lastWasColon = false;
          break;
        case 10:
          type = lastWasColon ? exports2.TOKEN_VALUE_STRING : exports2.TOKEN_PROPERTY_NAME;
          lastWasColon = false;
          break;
        case 11:
          type = exports2.TOKEN_VALUE_NUMBER;
          lastWasColon = false;
          break;
      }
      if (comments) {
        switch (kind) {
          case 12:
            type = exports2.TOKEN_COMMENT_LINE;
            break;
          case 13:
            type = exports2.TOKEN_COMMENT_BLOCK;
            break;
        }
      }
...
define("vs/language/json/jsonMode", ["require", "exports", "./workerManager", "./languageFeatures", "./tokenization"], function(require2, exports2, workerManager_1, languageFeatures, tokenization_1) {
  "use strict";
  Object.defineProperty(exports2, "__esModule", {
    value: true
  });
