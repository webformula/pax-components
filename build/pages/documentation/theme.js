...
import themeGenerator2 from "../../themeGenerator.js";
export default class ThemePage extends Page {
  ...
  getThemeCss() {
    return themeGenerator2.generateThemeCss(JSON.stringify(this.setValues));
  }
  ...
  copyTheme() {
    const css = themeGenerator2.generateThemeCss(JSON.stringify(this.setValues));
    navigator.clipboard.writeText(css).then(() => {
      ...
      MDWSnackbar.show({
        message: "copy to clipbard denied"
      });
    });
  }
  downloadTheme() {
