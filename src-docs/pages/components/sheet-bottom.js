    ...
    return /* html */`
      ...
      <article class="page-article">
        ...
        <div class="showcase mdw-elevation-1" style="overflow: hidden">
          ...
          <mdw-sheet-bottom id="theSheet" mdw-title="Standard sheet" class="mdw-shaped">
            <mdw-header class="mdw-primary mdw-two-line">
              <mdw-sheet-top-bar>
                <mdw-button class="mdw-icon" onclick="document.querySelector('#theSheet').minimize()">
        ...
        <div style="display: inline-block">
          ...
          <anchor-link selector="#modal-basic">Modal</anchor-link>
          <anchor-link selector="#standard-basic">Standard</anchor-link>
          <anchor-link selector="#modal-shaped">Shaped</anchor-link>
        </div>
        ...
        <mdw-card id="standard-basic">
          ...
          <div class="mdw-card__content--no-padding">
            <monaco-editor language="html">
              ...
              <mdw-header class="mdw-primary mdw-two-line">
                <mdw-sheet-top-bar>
                  <mdw-button class="mdw-icon" onclick="theSheet.minimize()">
                    <mdw-icon>keyboard_arrow_down</mdw-icon>
                  </mdw-button>
