  ...
  template() {
    return /* html */`
      <article class="page-article">
        ...
        <a href="https://material.io/design/components/progress-indicators.html#circular-progress-indicators" target="_new">Material Design Guidlines: Circular progress</a>
